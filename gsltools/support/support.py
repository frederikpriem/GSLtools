...
def merge_libraries(lib_paths, out_path,
    ...
    :param out_path: str
    :param source: iterable, containing a string for each library, to denote source of spectra in new final_libraries library
    ...
    metadata['description'] = 'final_libraries library'
